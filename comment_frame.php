...
<body>
	...
	* {
	...
	if(isset($_POST['postComment' . $post_id])) {
		...
		$insert_post = mysqli_query($conn, "INSERT INTO post_comments(post_body,posted_by,posted_to,date_added,removed,post_id) VALUES ( '$post_body', '$userLoggedIn', '$posted_to', '$date_time_now', 'no', '$post_id')");
	...
	<!-- Load comments -->
	<?php  
	$get_comments = mysqli_query($conn, "SELECT * FROM post_comments WHERE post_id='$post_id' ORDER BY id ASC");
